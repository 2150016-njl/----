...
def main():
    ...
    config_path = root_path / 'config/PTM/default.yaml'
    model_dir = root_path / 'models/Pretrain_model/checkpoints'
    ...
    # 数据准备
    data_dir = root_path / 'datasets/processed_data/SPI_PTM'  # 数据文件夹路径
    # 数据处理
    ...
    # 可视化预测结果
    print("开始可视化...")
    result_path = root_path / 'results/Pretrain_model/'
    result_path.mkdir(parents=True, exist_ok=True)
    visualize_predictions_and_statistics(predictions, ground_truth, result_path,
