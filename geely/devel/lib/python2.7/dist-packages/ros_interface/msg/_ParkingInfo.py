...
class ParkingInfo(genpy.Message):
  _md5sum = "9c7785e504d091d658cd31aca35c7f91"
...
"""
  __slots__ = ['header','parking_space_id','parking_type','confidence','center_point_of_parking','theta','width','length','yaw_offset','polygon','sensor_id','is_lane_width_valid','lane_width','parking_stoppers','parking_direction_type','parking_source_type']
  _slot_types = ['std_msgs/Header','int32','int32','float64','ros_interface/Point3D','float64','float64','float64','float64','ros_interface/Polygon3D','int32','bool','float64','ros_interface/ParkingStopper[]','int32','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,parking_space_id,parking_type,confidence,center_point_of_parking,theta,width,length,yaw_offset,polygon,sensor_id,is_lane_width_valid,lane_width,parking_stoppers,parking_direction_type,parking_source_type
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2i8di().pack(_x.parking_space_id, _x.parking_type, _x.confidence, _x.center_point_of_parking.x, _x.center_point_of_parking.y, _x.center_point_of_parking.z, _x.theta, _x.width, _x.length, _x.yaw_offset, _x.polygon.coordinate_system))
      ...
      for val1 in self.parking_stoppers:
        ...
        for val2 in val1.stopper_points_abs:
          ...
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      _x = self
      buff.write(_get_struct_2i().pack(_x.parking_direction_type, _x.parking_source_type))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.parking_space_id, _x.parking_type, _x.confidence, _x.center_point_of_parking.x, _x.center_point_of_parking.y, _x.center_point_of_parking.z, _x.theta, _x.width, _x.length, _x.yaw_offset, _x.polygon.coordinate_system,) = _get_struct_2i8di().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.polygon.points = []
      ...
      (_x.parking_direction_type, _x.parking_source_type,) = _get_struct_2i().unpack(str[start:end])
      return self
...
def _get_struct_2i():
    ...
    return _struct_2i
_struct_2i8di = None
def _get_struct_2i8di():
    global _struct_2i8di
    if _struct_2i8di is None:
        _struct_2i8di = struct.Struct("<2i8di")
    return _struct_2i8di
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
