...
class HMIParkingInfoList(genpy.Message):
  _md5sum = "3ee1c963e4488266db67d36b454f5473"
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.parking_info:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _x = val1
        buff.write(_get_struct_2iB().pack(_x.parking_space_id, _x.parking_type, _x.is_parking_enable))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.parking_space_id, _x.parking_type, _x.is_parking_enable,) = _get_struct_2iB().unpack(str[start:end])
