...
class ParkingInfoList(genpy.Message):
  _md5sum = "77a3c4d9d65a30e730ec033b3edaced6"
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.parking_info:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _x = val1
        buff.write(_get_struct_2id().pack(_x.parking_space_id, _x.parking_type, _x.confidence))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.parking_space_id, _x.parking_type, _x.confidence,) = _get_struct_2id().unpack(str[start:end])
