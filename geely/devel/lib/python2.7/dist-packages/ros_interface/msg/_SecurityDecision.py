...
class SecurityDecision(genpy.Message):
  _md5sum = "12f094a22d15ee8e4e9e06d46a5b0c22"
...
"""
  __slots__ = ['header','warning_command','motion_alarm','brake_report','change_lane_command','trajectory_limit_command','park_command','drivingmode_report']
  _slot_types = ['std_msgs/Header','ros_interface/WarningCommand','ros_interface/WarningCommand','int32','int32','ros_interface/TrajectoryLimitCommand','int32','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,warning_command,motion_alarm,brake_report,change_lane_command,trajectory_limit_command,park_command,drivingmode_report
    ...
    if args or kwds:
      ...
      if self.motion_alarm is None:
        self.motion_alarm = ros_interface.msg.WarningCommand()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_10iBdBd2i().pack(_x.warning_command.sound_alarm, _x.warning_command.light_alarm, _x.warning_command.media_alarm, _x.warning_command.motion_alarm, _x.motion_alarm.sound_alarm, _x.motion_alarm.light_alarm, _x.motion_alarm.media_alarm, _x.motion_alarm.motion_alarm, _x.brake_report, _x.change_lane_command, _x.trajectory_limit_command.speed_limit_enable, _x.trajectory_limit_command.speed_limit, _x.trajectory_limit_command.kappa_limit_enable, _x.trajectory_limit_command.kappa_limit, _x.park_command, _x.drivingmode_report))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.warning_command.sound_alarm, _x.warning_command.light_alarm, _x.warning_command.media_alarm, _x.warning_command.motion_alarm, _x.motion_alarm.sound_alarm, _x.motion_alarm.light_alarm, _x.motion_alarm.media_alarm, _x.motion_alarm.motion_alarm, _x.brake_report, _x.change_lane_command, _x.trajectory_limit_command.speed_limit_enable, _x.trajectory_limit_command.speed_limit, _x.trajectory_limit_command.kappa_limit_enable, _x.trajectory_limit_command.kappa_limit, _x.park_command, _x.drivingmode_report,) = _get_struct_10iBdBd2i().unpack(str[start:end])
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_10iBdBd2i = None
def _get_struct_10iBdBd2i():
    global _struct_10iBdBd2i
    if _struct_10iBdBd2i is None:
        _struct_10iBdBd2i = struct.Struct("<10iBdBd2i")
    return _struct_10iBdBd2i
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
