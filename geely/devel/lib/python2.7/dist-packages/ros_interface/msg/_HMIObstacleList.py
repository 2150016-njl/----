...
class HMIObstacleList(genpy.Message):
  _md5sum = "e5aa916b0597c4e1f642a5f453f551db"
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.obstacle:
        ...
        _x = _v2
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(val1.points_vehicle)
        buff.write(_struct_I.pack(length))
        for val2 in val1.points_vehicle:
          _x = val2
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(val1.points_abs)
        buff.write(_struct_I.pack(length))
        for val2 in val1.points_abs:
          _x = val2
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _x = val1
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          val1.points_vehicle.append(val2)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.points_abs = []
