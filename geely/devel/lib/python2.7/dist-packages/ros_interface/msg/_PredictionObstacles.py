...
class PredictionObstacles(genpy.Message):
  _md5sum = "9354ec2a726cf7a2762b6008aa699e3f"
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.prediction_obstacles:
        ...
        _x = _v10.priority
        buff.write(_get_struct_i().pack(_x))
        _v11 = val1.interactive_tag
        _x = _v11.interactive_tag
        buff.write(_get_struct_i().pack(_x))
        _x = val1.is_static
        buff.write(_get_struct_B().pack(_x))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v12.theta,) = _get_struct_d().unpack(str[start:end])
        _v14 = _v12.velocity
        _x = _v14
        start = end
        end += 24
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v12.polygon_point.append(val3)
        _x = _v12
        start = end
        end += 33
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v16 = _v12.acceleration
        _x = _v16
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v17 = _v12.anchor_point
        _x = _v17
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        ...
        _v12.position_covariance = s.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v12.velocity_covariance = s.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v12.acceleration_covariance = s.unpack(str[start:end])
        start = end
        end += 1
        (_v12.light_status,) = _get_struct_B().unpack(str[start:end])
        _x = val1
        start = end
        end += 16
        ...
        (_v20.type,) = _get_struct_i().unpack(str[start:end])
        _v21 = val1.priority
        start = end
        end += 4
        (_v21.priority,) = _get_struct_i().unpack(str[start:end])
        _v22 = val1.interactive_tag
        start = end
        end += 4
        (_v22.interactive_tag,) = _get_struct_i().unpack(str[start:end])
        start = end
        end += 1
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.prediction_obstacles:
        ...
        _x = _v23
        buff.write(_get_struct_3d().pack(_x.length, _x.width, _x.height))
        length = len(_v23.polygon_point)
        buff.write(_struct_I.pack(length))
        for val3 in _v23.polygon_point:
          _x = val3
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _x = _v23
        buff.write(_get_struct_d2i2dB().pack(_x.tracking_time, _x.type, _x.lane_position, _x.confidence, _x.timestamp, _x.confidence_type))
        ...
        _x = _v26
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v27 = _v23.acceleration
        _x = _v27
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v28 = _v23.anchor_point
        _x = _v28
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v23.bounding_box)
        buff.write(_struct_I.pack(length))
        for val3 in _v23.bounding_box:
          _x = val3
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _x = _v23
        buff.write(_get_struct_id().pack(_x.sub_type, _x.height_above_ground))
        length = len(_v23.position_covariance)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(_v23.position_covariance.tostring())
        length = len(_v23.velocity_covariance)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(_v23.velocity_covariance.tostring())
        length = len(_v23.acceleration_covariance)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(_v23.acceleration_covariance.tostring())
        _x = _v23.light_status
        buff.write(_get_struct_B().pack(_x))
        _x = val1
        buff.write(_get_struct_2d().pack(_x.timestamp, _x.predicted_period))
        length = len(val1.trajectory)
        ...
        for val2 in val1.trajectory:
          ...
          buff.write(_struct_I.pack(length))
          for val3 in val2.trajectory_points:
            _v29 = val3.path_point
            _x = _v29
            buff.write(_get_struct_11d().pack(_x.x, _x.y, _x.z, _x.theta, _x.kappa, _x.s, _x.dkappa, _x.ddkappa, _x.lane_id, _x.x_derivative, _x.y_derivative))
            _x = val3
            buff.write(_get_struct_4dB2di().pack(_x.v, _x.a, _x.relative_time, _x.da, _x.is_steer_valid, _x.front_steer, _x.rear_steer, _x.gear))
            _v30 = val3.gaussian_info
            _x = _v30
            buff.write(_get_struct_7d().pack(_x.sigma_x, _x.sigma_y, _x.correlation, _x.area_probability, _x.ellipse_a, _x.ellipse_b, _x.theta_a))
        _v31 = val1.intent
        _x = _v31.type
        ...
        _x = _v32.priority
        buff.write(_get_struct_i().pack(_x))
        _v33 = val1.interactive_tag
        _x = _v33.interactive_tag
        buff.write(_get_struct_i().pack(_x))
        _x = val1.is_static
        buff.write(_get_struct_B().pack(_x))
      _x = self
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v34.theta,) = _get_struct_d().unpack(str[start:end])
        _v36 = _v34.velocity
        _x = _v36
        start = end
        end += 24
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v34.polygon_point.append(val3)
        _x = _v34
        start = end
        end += 33
        (_x.tracking_time, _x.type, _x.lane_position, _x.confidence, _x.timestamp, _x.confidence_type,) = _get_struct_d2i2dB().unpack(str[start:end])
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v38 = _v34.acceleration
        _x = _v38
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v39 = _v34.anchor_point
        _x = _v39
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        ...
        _v34.position_covariance = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v34.velocity_covariance = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v34.acceleration_covariance = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
        start = end
        end += 1
        (_v34.light_status,) = _get_struct_B().unpack(str[start:end])
        _x = val1
        start = end
        end += 16
        (_x.timestamp, _x.predicted_period,) = _get_struct_2d().unpack(str[start:end])
        ...
        (_v42.type,) = _get_struct_i().unpack(str[start:end])
        _v43 = val1.priority
        start = end
        end += 4
        (_v43.priority,) = _get_struct_i().unpack(str[start:end])
        _v44 = val1.interactive_tag
        start = end
        end += 4
        (_v44.interactive_tag,) = _get_struct_i().unpack(str[start:end])
        start = end
        end += 1
        (val1.is_static,) = _get_struct_B().unpack(str[start:end])
        val1.is_static = bool(val1.is_static)
