...
class HMIParkingInfo(genpy.Message):
  _md5sum = "64c69f8d588c838a48403d35450d0ea7"
...
Point3D[] points # 三维点集
"""
  __slots__ = ['header','parking_space_id','parking_type','is_parking_enable','center_point_of_parking','theta','width','length','is_custom_parking','polygon','parking_source_type']
  _slot_types = ['std_msgs/Header','int32','int32','bool','ros_interface/Point3D','float64','float64','float64','bool','ros_interface/Polygon3D','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,parking_space_id,parking_type,is_parking_enable,center_point_of_parking,theta,width,length,is_custom_parking,polygon,parking_source_type
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2iB6dBi().pack(_x.parking_space_id, _x.parking_type, _x.is_parking_enable, _x.center_point_of_parking.x, _x.center_point_of_parking.y, _x.center_point_of_parking.z, _x.theta, _x.width, _x.length, _x.is_custom_parking, _x.polygon.coordinate_system))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.parking_space_id, _x.parking_type, _x.is_parking_enable, _x.center_point_of_parking.x, _x.center_point_of_parking.y, _x.center_point_of_parking.z, _x.theta, _x.width, _x.length, _x.is_custom_parking, _x.polygon.coordinate_system,) = _get_struct_2iB6dBi().unpack(str[start:end])
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_2iB6dBi = None
def _get_struct_2iB6dBi():
    global _struct_2iB6dBi
    if _struct_2iB6dBi is None:
        _struct_2iB6dBi = struct.Struct("<2iB6dBi")
    return _struct_2iB6dBi
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
