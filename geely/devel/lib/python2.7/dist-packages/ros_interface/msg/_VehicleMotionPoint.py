...
class VehicleMotionPoint(genpy.Message):
  _md5sum = "3bd1f282bdb71dadf0b9039f3bb5e35f"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_15dB2di8d().pack(_x.trajectory_point.path_point.x, _x.trajectory_point.path_point.y, _x.trajectory_point.path_point.z, _x.trajectory_point.path_point.theta, _x.trajectory_point.path_point.kappa, _x.trajectory_point.path_point.s, _x.trajectory_point.path_point.dkappa, _x.trajectory_point.path_point.ddkappa, _x.trajectory_point.path_point.lane_id, _x.trajectory_point.path_point.x_derivative, _x.trajectory_point.path_point.y_derivative, _x.trajectory_point.v, _x.trajectory_point.a, _x.trajectory_point.relative_time, _x.trajectory_point.da, _x.trajectory_point.is_steer_valid, _x.trajectory_point.front_steer, _x.trajectory_point.rear_steer, _x.trajectory_point.gear, _x.trajectory_point.gaussian_info.sigma_x, _x.trajectory_point.gaussian_info.sigma_y, _x.trajectory_point.gaussian_info.correlation, _x.trajectory_point.gaussian_info.area_probability, _x.trajectory_point.gaussian_info.ellipse_a, _x.trajectory_point.gaussian_info.ellipse_b, _x.trajectory_point.gaussian_info.theta_a, _x.steer))
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_15dB2di8d = None
def _get_struct_15dB2di8d():
    global _struct_15dB2di8d
    if _struct_15dB2di8d is None:
        _struct_15dB2di8d = struct.Struct("<15dB2di8d")
    return _struct_15dB2di8d
