...
class TrajectoryPoint(genpy.Message):
  _md5sum = "83c41220037674c2962fa7a8fe3a16d3"
...
"""
  __slots__ = ['path_point','v','a','relative_time','da','is_steer_valid','front_steer','rear_steer','gear','gaussian_info']
  _slot_types = ['ros_interface/PathPoint','float64','float64','float64','float64','bool','float64','float64','int32','ros_interface/GaussianInfo']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       path_point,v,a,relative_time,da,is_steer_valid,front_steer,rear_steer,gear,gaussian_info
    ...
    if args or kwds:
      ...
      if self.gaussian_info is None:
        self.gaussian_info = ros_interface.msg.GaussianInfo()
    else:
      self.path_point = ros_interface.msg.PathPoint()
      self.v = 0.
      self.a = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_15dB2di7d().pack(_x.path_point.x, _x.path_point.y, _x.path_point.z, _x.path_point.theta, _x.path_point.kappa, _x.path_point.s, _x.path_point.dkappa, _x.path_point.ddkappa, _x.path_point.lane_id, _x.path_point.x_derivative, _x.path_point.y_derivative, _x.v, _x.a, _x.relative_time, _x.da, _x.is_steer_valid, _x.front_steer, _x.rear_steer, _x.gear, _x.gaussian_info.sigma_x, _x.gaussian_info.sigma_y, _x.gaussian_info.correlation, _x.gaussian_info.area_probability, _x.gaussian_info.ellipse_a, _x.gaussian_info.ellipse_b, _x.gaussian_info.theta_a))
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_15dB2di7d = None
def _get_struct_15dB2di7d():
    global _struct_15dB2di7d
    if _struct_15dB2di7d is None:
        _struct_15dB2di7d = struct.Struct("<15dB2di7d")
    return _struct_15dB2di7d
