...
"""autogenerated by genpy from perception_ros_msg/LidarFrameMsg.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/String','std_msgs/Float64','perception_ros_msg/Pose','perception_ros_msg/Point3d','perception_ros_msg/PoseMap','std_msgs/Int32','perception_ros_msg/Indices','perception_ros_msg/Objects','std_msgs/Bool','perception_ros_msg/Point4f[]','std_msgs/Bool','perception_ros_msg/Objects','std_msgs/Bool','perception_ros_msg/FreeSpaceInfos','std_msgs/Bool','perception_ros_msg/Lanes','std_msgs/Bool','perception_ros_msg/RoadEdges','std_msgs/Bool','perception_ros_msg/Indices','perception_ros_msg/Indices','perception_ros_msg/Indices']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.global_pose is None:
        self.global_pose = perception_ros_msg.msg.Pose()
      if self.gps_origin is None:
        self.gps_origin = perception_ros_msg.msg.Point3d()
      if self.status_pose_map is None:
        self.status_pose_map = perception_ros_msg.msg.PoseMap()
      if self.status is None:
        self.status = std_msgs.msg.Int32()
      if self.valid_indices is None:
        self.valid_indices = perception_ros_msg.msg.Indices()
      if self.objects is None:
        self.objects = perception_ros_msg.msg.Objects()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = perception_ros_msg.msg.AxisStatusPose()
        _v239 = val1.status
        start = end
        end += 4
      ...
      for i in range(0, length):
        val1 = perception_ros_msg.msg.Object()
        _v248 = val1.coreinfo
        ...
        _v312.polygon = []
        for i in range(0, length):
          val3 = perception_ros_msg.msg.Point3f()
          _v314 = val3.x
          start = end
          end += 4
      ...
      self.scan_pointcloud = []
      for i in range(0, length):
        val1 = perception_ros_msg.msg.Point4f()
        _v342 = val1.x
        start = end
        end += 4
      ...
      for i in range(0, length):
        val1 = perception_ros_msg.msg.Point3f()
        _v440 = val1.x
        start = end
        end += 4
      ...
      self.lanes.lanes = []
      for i in range(0, length):
        val1 = perception_ros_msg.msg.Lane()
        _v443 = val1.lane_id
        start = end
        end += 4
      ...
      for i in range(0, length):
        val1 = perception_ros_msg.msg.RoadEdge()
