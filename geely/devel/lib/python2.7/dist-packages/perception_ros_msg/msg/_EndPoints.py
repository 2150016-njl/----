...
"""autogenerated by genpy from perception_ros_msg/EndPoints.msg. Do not edit."""
import codecs
import sys
...
class EndPoints(genpy.Message):
  ...
  _type = "perception_ros_msg/EndPoints"
...
float32 data"""
  __slots__ = ['start','end']
  _slot_types = ['perception_ros_msg/Point2f','perception_ros_msg/Point2f']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.start is None:
        self.start = perception_ros_msg.msg.Point2f()
      if self.end is None:
        self.end = perception_ros_msg.msg.Point2f()
    else:
      self.start = perception_ros_msg.msg.Point2f()
      self.end = perception_ros_msg.msg.Point2f()
