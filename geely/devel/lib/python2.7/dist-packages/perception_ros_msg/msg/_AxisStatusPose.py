...
"""autogenerated by genpy from perception_ros_msg/AxisStatusPose.msg. Do not edit."""
import codecs
import sys
...
class AxisStatusPose(genpy.Message):
  ...
  _type = "perception_ros_msg/AxisStatusPose"
...
float32 data"""
  ...
  _slot_types = ['std_msgs/Int32','perception_ros_msg/Pose']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.pose is None:
        self.pose = perception_ros_msg.msg.Pose()
    else:
      self.status = std_msgs.msg.Int32()
      self.pose = perception_ros_msg.msg.Pose()
