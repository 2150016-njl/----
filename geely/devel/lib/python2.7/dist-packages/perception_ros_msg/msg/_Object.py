...
"""autogenerated by genpy from perception_ros_msg/Object.msg. Do not edit."""
import codecs
import sys
...
class Object(genpy.Message):
  ...
  _type = "perception_ros_msg/Object"
...
"""
  ...
  _slot_types = ['perception_ros_msg/CoreInfo','std_msgs/Bool','perception_ros_msg/SupplementInfo']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.coreinfo is None:
        self.coreinfo = perception_ros_msg.msg.CoreInfo()
      if self.hassupplmentinfo is None:
        self.hassupplmentinfo = std_msgs.msg.Bool()
      if self.supplementinfo is None:
        self.supplementinfo = perception_ros_msg.msg.SupplementInfo()
    else:
      self.coreinfo = perception_ros_msg.msg.CoreInfo()
      self.hassupplmentinfo = std_msgs.msg.Bool()
      self.supplementinfo = perception_ros_msg.msg.SupplementInfo()
