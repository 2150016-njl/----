...
struct ParkingStopper_
{
  ...
  _center_point_abs_type center_point_abs;
   ...
   typedef std::vector< ::ros_interface::Point3D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Point3D_<ContainerAllocator> >::other >  _stopper_points_vehicle_type;
  _stopper_points_vehicle_type stopper_points_vehicle;

   typedef std::vector< ::ros_interface::Point3D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Point3D_<ContainerAllocator> >::other >  _stopper_points_abs_type;
