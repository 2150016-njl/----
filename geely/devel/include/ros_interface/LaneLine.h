...
struct LaneLine_
{
  ...
  _curve_abs_type curve_abs;
   ...
   typedef std::vector< ::ros_interface::Point3D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Point3D_<ContainerAllocator> >::other >  _pts_vehicle_type;
  _pts_vehicle_type pts_vehicle;

   typedef std::vector< ::ros_interface::Point2D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Point2D_<ContainerAllocator> >::other >  _pts_image_type;
  _pts_image_type pts_image;

   typedef std::vector< ::ros_interface::Point3D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Point3D_<ContainerAllocator> >::other >  _pts_abs_type;
  ...
  _image_end_point_type image_end_point;
   ...
   typedef std::vector< ::ros_interface::Point2D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Point2D_<ContainerAllocator> >::other >  _pts_key_type;
  ...
  _fused_lane_type_type fused_lane_type;
   ...
   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _homography_mat_type;
  _homography_mat_type homography_mat;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _homography_mat_inv_type;
