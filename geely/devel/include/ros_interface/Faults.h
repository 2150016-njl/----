...
struct Faults_
{
  ...
  _is_active_type is_active;
   ...
   typedef std::vector< ::ros_interface::Fault_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Fault_<ContainerAllocator> >::other >  _faults_type;
  _faults_type faults;
