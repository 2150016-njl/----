...
struct CameraParkingInfo_
{
  ...
  _yaw_offset_type yaw_offset;
   ...
   typedef std::vector< ::ros_interface::ImageKeyPoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::ImageKeyPoint_<ContainerAllocator> >::other >  _parking_points_in_image_type;
