...
struct RoutingResponse_
{
  ...
  _route_reason_type route_reason;
   ...
   typedef std::vector< ::ros_interface::LaneInfo_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::LaneInfo_<ContainerAllocator> >::other >  _lane_list_type;
