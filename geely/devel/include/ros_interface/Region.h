...
struct Region_
{
  ...
  _rank_risk_type rank_risk;
   ...
   typedef std::vector< ::ros_interface::Point3D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Point3D_<ContainerAllocator> >::other >  _region_polygon_type;
