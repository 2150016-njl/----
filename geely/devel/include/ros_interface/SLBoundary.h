...
struct SLBoundary_
{
  ...
  _end_l_type end_l;
   ...
   typedef std::vector< ::ros_interface::SLPoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::SLPoint_<ContainerAllocator> >::other >  _boundary_point_type;
