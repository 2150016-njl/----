...
struct HMIObstacleList_
{
  ...
  _sensor_id_type sensor_id;
   ...
   typedef std::vector< ::ros_interface::HMIObstacle_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::HMIObstacle_<ContainerAllocator> >::other >  _obstacle_type;
...
struct MD5Sum< ::ros_interface::HMIObstacleList_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xe5aa916b0597c4e1ULL;
  static const uint64_t static_value2 = 0xf642a5f453f551dbULL;
};
