...
struct RoadMarkList_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::ros_interface::RoadMark_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::RoadMark_<ContainerAllocator> >::other >  _roadmarks_type;
