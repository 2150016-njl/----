...
struct ObstacleFeature_
{
  ...
  _is_near_junction_type is_near_junction;
   ...
   typedef std::vector< ::ros_interface::PredictionTrajectoryPoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::PredictionTrajectoryPoint_<ContainerAllocator> >::other >  _future_trajectory_points_type;
  _future_trajectory_points_type future_trajectory_points;

   typedef std::vector< ::ros_interface::TrajectoryPointInPrediction_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::TrajectoryPointInPrediction_<ContainerAllocator> >::other >  _short_term_predicted_trajectory_points_type;
  _short_term_predicted_trajectory_points_type short_term_predicted_trajectory_points;

   typedef std::vector< ::ros_interface::TrajectoryInPrediction_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::TrajectoryInPrediction_<ContainerAllocator> >::other >  _predicted_trajectory_type;
  _predicted_trajectory_type predicted_trajectory;

   typedef std::vector< ::ros_interface::TrajectoryPointInPrediction_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::TrajectoryPointInPrediction_<ContainerAllocator> >::other >  _adc_trajectory_point_type;
...
struct MD5Sum< ::ros_interface::ObstacleFeature_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xf5db825b7f5c05c8ULL;
  static const uint64_t static_value2 = 0x40b2b7624a450755ULL;
};
