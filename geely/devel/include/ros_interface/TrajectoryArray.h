...
struct TrajectoryArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::ros_interface::Path_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Path_<ContainerAllocator> >::other >  _spline_s_type;
  _spline_s_type spline_s;

   typedef std::vector< ::ros_interface::Path_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Path_<ContainerAllocator> >::other >  _qp_smooth_type;
  _qp_smooth_type qp_smooth;

   typedef std::vector< ::ros_interface::Trajectory_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Trajectory_<ContainerAllocator> >::other >  _trajectory_list_type;
...
struct MD5Sum< ::ros_interface::TrajectoryArray_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xf6fa2156da02dea6ULL;
  static const uint64_t static_value2 = 0x6a565f8c06f54666ULL;
};
