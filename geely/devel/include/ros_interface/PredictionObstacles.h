...
struct PredictionObstacles_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::ros_interface::PredictionObstacle_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::PredictionObstacle_<ContainerAllocator> >::other >  _prediction_obstacles_type;
...
struct MD5Sum< ::ros_interface::PredictionObstacles_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x9354ec2a726cf7a2ULL;
  static const uint64_t static_value2 = 0x762b6008aa699e3fULL;
};
