...
struct RadarObstacleListMsg_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::ros_interface::RadarObstacle_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::RadarObstacle_<ContainerAllocator> >::other >  _radar_obstacle_type;
