...
struct PlanningAnalysis_
{
  ...
  _generator_time_type generator_time;
   ...
   typedef std::vector< ::ros_interface::TimeConsume_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::TimeConsume_<ContainerAllocator> >::other >  _evaluator_time_type;
...
struct MD5Sum< ::ros_interface::PlanningAnalysis_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xc63a3ff5e3802e16ULL;
  static const uint64_t static_value2 = 0x819f364cf95482edULL;
};
