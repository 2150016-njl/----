...
struct TrafficLightMsg_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::ros_interface::TrafficLight_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::TrafficLight_<ContainerAllocator> >::other >  _traffic_light_type;
