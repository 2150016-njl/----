...
struct DiagnosticArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::ros_interface::DiagnosticStatus_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::DiagnosticStatus_<ContainerAllocator> >::other >  _status_type;
  _status_type status;
