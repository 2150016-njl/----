...
struct Obstacle_
{
  ...
  _height_type height;
   ...
   typedef std::vector< ::ros_interface::ImageKeyPoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::ImageKeyPoint_<ContainerAllocator> >::other >  _image_key_points_type;
  _image_key_points_type image_key_points;

   typedef std::vector< ::ros_interface::Point3D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Point3D_<ContainerAllocator> >::other >  _polygon_point_abs_type;
  _polygon_point_abs_type polygon_point_abs;

   typedef std::vector< ::ros_interface::Point3D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Point3D_<ContainerAllocator> >::other >  _polygon_point_vehicle_type;
  ...
  _confidence_type_type confidence_type;
   ...
   typedef std::vector< ::ros_interface::Point3D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Point3D_<ContainerAllocator> >::other >  _drops_type;
  _drops_type drops;
  ...
  _height_above_ground_type height_above_ground;
   ...
   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _position_abs_covariance_type;
  _position_abs_covariance_type position_abs_covariance;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _velocity_abs_covariance_type;
  _velocity_abs_covariance_type velocity_abs_covariance;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _acceleration_abs_covariance_type;
  ...
  _theta_abs_covariance_type theta_abs_covariance;
   ...
   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _position_vehicle_covariance_type;
  _position_vehicle_covariance_type position_vehicle_covariance;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _velocity_vehicle_covariance_type;
  _velocity_vehicle_covariance_type velocity_vehicle_covariance;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _acceleration_vehicle_covariance_type;
