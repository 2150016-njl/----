...
struct Events_
{
  ...
  _version_type version;
   ...
   typedef std::vector< ::ros_interface::Event_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Event_<ContainerAllocator> >::other >  _events_type;
  _events_type events;
