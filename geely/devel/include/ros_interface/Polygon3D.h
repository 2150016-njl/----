...
struct Polygon3D_
{
  ...
  _coordinate_system_type coordinate_system;
   ...
   typedef std::vector< ::ros_interface::Point3D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Point3D_<ContainerAllocator> >::other >  _points_type;
  _points_type points;
