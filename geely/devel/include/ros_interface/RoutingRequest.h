...
struct RoutingRequest_
{
  ...
  _header_type header;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _request_source_type;
  ...
  _num_of_kp_type num_of_kp;
   ...
   typedef std::vector< ::ros_interface::KeyPoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::KeyPoint_<ContainerAllocator> >::other >  _key_point_list_type;
...
struct Printer< ::ros_interface::RoutingRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ros_interface::RoutingRequest_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.request_source);
