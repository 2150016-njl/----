...
struct ParkingInfoList_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::ros_interface::ParkingInfo_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::ParkingInfo_<ContainerAllocator> >::other >  _parking_info_type;
...
struct MD5Sum< ::ros_interface::ParkingInfoList_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x77a3c4d9d65a30e7ULL;
  static const uint64_t static_value2 = 0x30ec033b3edaced6ULL;
};
