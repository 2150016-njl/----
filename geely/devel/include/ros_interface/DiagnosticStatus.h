...
struct DiagnosticStatus_
{
  ...
  _hardware_id_type hardware_id;
   ...
   typedef std::vector< ::ros_interface::KeyValues_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::KeyValues_<ContainerAllocator> >::other >  _values_type;
  _values_type values;
