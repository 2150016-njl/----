...
struct VehicleParam_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _brand_type;
  _brand_type brand;
...
struct Printer< ::ros_interface::VehicleParam_<ContainerAllocator> >
{
  ...
  {
    s << indent << "brand: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.brand);
    s << indent << "steer_mode: ";
