...
struct ObstacleList_
{
  ...
  _sensor_id_type sensor_id;
   ...
   typedef std::vector< ::ros_interface::Obstacle_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Obstacle_<ContainerAllocator> >::other >  _obstacle_type;
