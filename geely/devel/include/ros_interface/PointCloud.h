...
struct PointCloud_
{
  ...
  _is_dense_type is_dense;
   ...
   typedef std::vector< ::ros_interface::PointXYZIRT_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::PointXYZIRT_<ContainerAllocator> >::other >  _point_type;
  _point_type point;
