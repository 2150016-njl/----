...
struct HMITrajectory_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::ros_interface::HMITrajectoryPoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::HMITrajectoryPoint_<ContainerAllocator> >::other >  _trajectory_points_type;
