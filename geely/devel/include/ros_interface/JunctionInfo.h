...
struct JunctionInfo_
{
  ...
  _distance_to_junction_type distance_to_junction;
   ...
   typedef std::vector< ::ros_interface::Point3D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Point3D_<ContainerAllocator> >::other >  _stop_line_type;
