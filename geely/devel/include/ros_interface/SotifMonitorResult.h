...
struct SotifMonitorResult_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::ros_interface::Region_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Region_<ContainerAllocator> >::other >  _region_value_type;
  _region_value_type region_value;

   typedef std::vector< ::ros_interface::Grid_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Grid_<ContainerAllocator> >::other >  _grid_map_type;
