...
struct LaneInfo_
{
  ...
  _type_type type;
   ...
   typedef std::vector< ::ros_interface::LanePoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::LanePoint_<ContainerAllocator> >::other >  _lane_points_type;
