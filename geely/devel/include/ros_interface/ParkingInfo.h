...
struct ParkingInfo_
{
  ...
  _lane_width_type lane_width;
   ...
   typedef std::vector< ::ros_interface::ParkingStopper_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::ParkingStopper_<ContainerAllocator> >::other >  _parking_stoppers_type;
...
struct MD5Sum< ::ros_interface::ParkingInfo_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x9c7785e504d091d6ULL;
  static const uint64_t static_value2 = 0x58cd31aca35c7f91ULL;
};
