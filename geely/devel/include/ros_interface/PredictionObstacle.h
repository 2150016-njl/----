...
struct PredictionObstacle_
{
  ...
  _predicted_period_type predicted_period;
   ...
   typedef std::vector< ::ros_interface::TrajectoryInPrediction_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::TrajectoryInPrediction_<ContainerAllocator> >::other >  _trajectory_type;
...
struct MD5Sum< ::ros_interface::PredictionObstacle_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xde205312bb9fab36ULL;
  static const uint64_t static_value2 = 0xd338b8733d52dd18ULL;
};
