...
struct LaneList_
{
  ...
  _sensor_calibrator_type sensor_calibrator;
   ...
   typedef std::vector< ::ros_interface::LaneLine_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::LaneLine_<ContainerAllocator> >::other >  _camera_laneline_type;
  _camera_laneline_type camera_laneline;

   typedef  ::ros_interface::HolisticPathPrediction_<ContainerAllocator>  _hpp_type;
  _hpp_type hpp;

   typedef std::vector< ::ros_interface::RoadMark_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::RoadMark_<ContainerAllocator> >::other >  _road_marks_type;
