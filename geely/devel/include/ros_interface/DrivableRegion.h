...
struct DrivableRegion_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::ros_interface::Polygon3D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Polygon3D_<ContainerAllocator> >::other >  _drivable_region_type;
