...
struct PerceptionObstacle_
{
  ...
  _height_type height;
   ...
   typedef std::vector< ::ros_interface::Point3D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Point3D_<ContainerAllocator> >::other >  _polygon_point_type;
  ...
  _anchor_point_type anchor_point;
   ...
   typedef std::vector< ::ros_interface::Point3D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Point3D_<ContainerAllocator> >::other >  _bounding_box_type;
  ...
  _height_above_ground_type height_above_ground;
   ...
   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _position_covariance_type;
  _position_covariance_type position_covariance;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _velocity_covariance_type;
  _velocity_covariance_type velocity_covariance;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _acceleration_covariance_type;
