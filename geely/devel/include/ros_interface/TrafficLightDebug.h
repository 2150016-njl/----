...
struct TrafficLightDebug_
{
  ...
  _cropbox_type cropbox;
   ...
   typedef std::vector< ::ros_interface::TrafficLightBox_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::TrafficLightBox_<ContainerAllocator> >::other >  _box_type;
  _box_type box;
  ...
  _camera_id_type camera_id;
   ...
   typedef std::vector< ::ros_interface::TrafficLightBox_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::TrafficLightBox_<ContainerAllocator> >::other >  _crop_roi_type;
  _crop_roi_type crop_roi;

   typedef std::vector< ::ros_interface::TrafficLightBox_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::TrafficLightBox_<ContainerAllocator> >::other >  _projected_roi_type;
  _projected_roi_type projected_roi;

   typedef std::vector< ::ros_interface::TrafficLightBox_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::TrafficLightBox_<ContainerAllocator> >::other >  _rectified_roi_type;
  _rectified_roi_type rectified_roi;

   typedef std::vector< ::ros_interface::TrafficLightBox_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::TrafficLightBox_<ContainerAllocator> >::other >  _debug_roi_type;
