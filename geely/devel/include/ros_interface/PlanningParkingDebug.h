...
struct PlanningParkingDebug_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::ros_interface::Polygon2D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Polygon2D_<ContainerAllocator> >::other >  _vehicle_preiew_polygon_type;
  _vehicle_preiew_polygon_type vehicle_preiew_polygon;

   typedef std::vector< ::ros_interface::Polygon2D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Polygon2D_<ContainerAllocator> >::other >  _obstacles_polygon_type;
  _obstacles_polygon_type obstacles_polygon;

   typedef std::vector< ::ros_interface::PathPoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::PathPoint_<ContainerAllocator> >::other >  _path_points_type;
  ...
  _yaw_error_type yaw_error;
   ...
   typedef std::vector< ::ros_interface::Point2dList_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Point2dList_<ContainerAllocator> >::other >  _obstacles_vec_type;
  _obstacles_vec_type obstacles_vec;

   typedef std::vector< ::ros_interface::TrajectoryPoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::TrajectoryPoint_<ContainerAllocator> >::other >  _warm_start_traj_type;
  _warm_start_traj_type warm_start_traj;

   typedef std::vector< ::ros_interface::TrajectoryPoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::TrajectoryPoint_<ContainerAllocator> >::other >  _smoothed_traj_stage1_type;
  _smoothed_traj_stage1_type smoothed_traj_stage1;

   typedef std::vector< ::ros_interface::TrajectoryPoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::TrajectoryPoint_<ContainerAllocator> >::other >  _smoothed_traj_stage2_type;
  ...
  _reference_line_type reference_line;
   ...
   typedef std::vector< ::ros_interface::Trajectory_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Trajectory_<ContainerAllocator> >::other >  _trajectory_array_type;
  ...
  _is_replan_type is_replan;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _replan_reason_type;
...
struct MD5Sum< ::ros_interface::PlanningParkingDebug_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x1b9cb6b363f6520fULL;
  static const uint64_t static_value2 = 0xfafa504a0b28d1b3ULL;
};
...
struct Printer< ::ros_interface::PlanningParkingDebug_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ros_interface::PlanningParkingDebug_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.replan_reason);
