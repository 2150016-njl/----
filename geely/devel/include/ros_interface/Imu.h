...
struct Imu_
{
  ...
  _orientation_type orientation;
   ...
   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _orientation_covariance_type;
  ...
  _angular_velocity_type angular_velocity;
   ...
   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _angular_velocity_covariance_type;
