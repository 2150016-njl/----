...
struct GlobalRouteMsg_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::ros_interface::LaneletInfo_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::LaneletInfo_<ContainerAllocator> >::other >  _route_type;
  _route_type route;
  ...
  _cur_mileage_type cur_mileage;
   ...
   typedef std::vector< ::ros_interface::LaneletInfo_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::LaneletInfo_<ContainerAllocator> >::other >  _cur_slice_type;
