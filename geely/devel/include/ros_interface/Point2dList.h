...
struct Point2dList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::ros_interface::Point2D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_interface::Point2D_<ContainerAllocator> >::other >  _point2d_list_type;
