...
class PlanningPath {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PlanningPath
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PlanningPath
    let len;
    let data = new PlanningPath(null);
  ...
  static datatype() {
    ...
    return 'rl_planning/PlanningPath';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlanningPath(null);
