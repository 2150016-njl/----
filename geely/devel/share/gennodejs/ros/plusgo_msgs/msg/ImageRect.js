...
class ImageRect {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('x_')) {
        this.x_ = initObj.x_
      }
      else {
        this.x_ = 0;
      }
      if (initObj.hasOwnProperty('y_')) {
        this.y_ = initObj.y_
      }
      else {
        this.y_ = 0;
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [x_]
    bufferOffset = _serializer.int32(obj.x_, buffer, bufferOffset);
    // Serialize message field [y_]
    bufferOffset = _serializer.int32(obj.y_, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [x_]
    data.x_ = _deserializer.int32(buffer, bufferOffset);
    // Deserialize message field [y_]
    data.y_ = _deserializer.int32(buffer, bufferOffset);
