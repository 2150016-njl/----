...
class Lanes {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.stop_line_dist = null;
      this.junction_status = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('next_direction')) {
        this.next_direction = initObj.next_direction
      }
      else {
        this.next_direction = 0;
      }
      if (initObj.hasOwnProperty('stop_line_dist')) {
        this.stop_line_dist = initObj.stop_line_dist
      }
      else {
        this.stop_line_dist = 0.0;
      }
      if (initObj.hasOwnProperty('junction_status')) {
        this.junction_status = initObj.junction_status
      }
      else {
        this.junction_status = false;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [next_direction]
    bufferOffset = _serializer.uint8(obj.next_direction, buffer, bufferOffset);
    // Serialize message field [stop_line_dist]
    bufferOffset = _serializer.float64(obj.stop_line_dist, buffer, bufferOffset);
    // Serialize message field [junction_status]
    bufferOffset = _serializer.bool(obj.junction_status, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [next_direction]
    data.next_direction = _deserializer.uint8(buffer, bufferOffset);
    // Deserialize message field [stop_line_dist]
    data.stop_line_dist = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [junction_status]
    data.junction_status = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.next_direction !== undefined) {
      resolved.next_direction = msg.next_direction;
    }
    else {
      resolved.next_direction = 0
    }

    if (msg.stop_line_dist !== undefined) {
      resolved.stop_line_dist = msg.stop_line_dist;
    }
    else {
      resolved.stop_line_dist = 0.0
    }

    if (msg.junction_status !== undefined) {
      resolved.junction_status = msg.junction_status;
    }
    else {
      resolved.junction_status = false
    }
