...
(cl:defmethod cl:initialize-instance :after ((m <Lane>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Lane)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name interface-msg:<Lane> is deprecated: use interface-msg:Lane instead.")))

(cl:ensure-generic-function 'lane_idx-val :lambda-list '(m))
(cl:defmethod lane_idx-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interface-msg:lane_idx-val is deprecated.  Use interface-msg:lane_idx instead.")
  (lane_idx m))

(cl:ensure-generic-function 'left_traverse_flag-val :lambda-list '(m))
(cl:defmethod left_traverse_flag-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interface-msg:left_traverse_flag-val is deprecated.  Use interface-msg:left_traverse_flag instead.")
...
(cl:defmethod right_traverse_flag-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interface-msg:right_traverse_flag-val is deprecated.  Use interface-msg:right_traverse_flag instead.")
  (right_traverse_flag m))

(cl:ensure-generic-function 'lane_width-val :lambda-list '(m))
(cl:defmethod lane_width-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interface-msg:lane_width-val is deprecated.  Use interface-msg:lane_width instead.")
  (lane_width m))
