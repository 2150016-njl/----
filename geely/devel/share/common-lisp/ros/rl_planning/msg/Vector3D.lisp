...
(cl:defmethod cl:initialize-instance :after ((m <Vector3D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vector3D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rl_planning-msg:<Vector3D> is deprecated: use rl_planning-msg:Vector3D instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Vector3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rl_planning-msg:x-val is deprecated.  Use rl_planning-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Vector3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rl_planning-msg:y-val is deprecated.  Use rl_planning-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Vector3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rl_planning-msg:z-val is deprecated.  Use rl_planning-msg:z instead.")
  (z m))
