...
(cl:defclass <Route> (roslisp-msg-protocol:ros-message)
  ((points
    :reader points
    :initarg :points
    :type (cl:vector global_route_msgs-msg:Route_point)
   :initform (cl:make-array 0 :element-type 'global_route_msgs-msg:Route_point :initial-element (cl:make-instance 'global_route_msgs-msg:Route_point))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Route>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Route)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name global_route_msgs-msg:<Route> is deprecated: use global_route_msgs-msg:Route instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <Route>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader global_route_msgs-msg:points-val is deprecated.  Use global_route_msgs-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Route>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'global_route_msgs-msg:Route_point))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Route>)))
  ...
  (cl:format cl:nil "Route_point[] points~%================================================================================~%MSG: global_route_msgs/Route_point~%float64 x~%float64 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Route)))
  "Returns full string definition for message of type 'Route"
  (cl:format cl:nil "Route_point[] points~%================================================================================~%MSG: global_route_msgs/Route_point~%float64 x~%float64 y~%~%~%"))
