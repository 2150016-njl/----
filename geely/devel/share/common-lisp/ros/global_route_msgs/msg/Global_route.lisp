...
(cl:defclass <Global_route> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (routes
    :reader routes
    :initarg :routes
    :type (cl:vector global_route_msgs-msg:Route)
   :initform (cl:make-array 0 :element-type 'global_route_msgs-msg:Route :initial-element (cl:make-instance 'global_route_msgs-msg:Route)))
   (target_route_id
...
(cl:defmethod cl:initialize-instance :after ((m <Global_route>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Global_route)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name global_route_msgs-msg:<Global_route> is deprecated: use global_route_msgs-msg:Global_route instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Global_route>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader global_route_msgs-msg:header-val is deprecated.  Use global_route_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'routes-val :lambda-list '(m))
(cl:defmethod routes-val ((m <Global_route>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader global_route_msgs-msg:routes-val is deprecated.  Use global_route_msgs-msg:routes instead.")
  (routes m))

(cl:ensure-generic-function 'target_route_id-val :lambda-list '(m))
(cl:defmethod target_route_id-val ((m <Global_route>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader global_route_msgs-msg:target_route_id-val is deprecated.  Use global_route_msgs-msg:target_route_id instead.")
  (target_route_id m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Global_route>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'routes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'global_route_msgs-msg:Route))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Global_route>)))
  ...
  "global_route_msgs/Global_route")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Global_route)))
  "Returns string type for a message object of type 'Global_route"
  "global_route_msgs/Global_route")
