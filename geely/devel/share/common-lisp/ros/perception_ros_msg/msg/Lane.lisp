...
(cl:defmethod cl:initialize-instance :after ((m <Lane>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Lane)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name perception_ros_msg-msg:<Lane> is deprecated: use perception_ros_msg-msg:Lane instead.")))

(cl:ensure-generic-function 'lane_id-val :lambda-list '(m))
(cl:defmethod lane_id-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:lane_id-val is deprecated.  Use perception_ros_msg-msg:lane_id instead.")
  (lane_id m))
