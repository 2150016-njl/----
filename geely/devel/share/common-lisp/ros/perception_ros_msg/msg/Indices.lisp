...
(cl:defmethod cl:initialize-instance :after ((m <Indices>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Indices)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name perception_ros_msg-msg:<Indices> is deprecated: use perception_ros_msg-msg:Indices instead.")))

(cl:ensure-generic-function 'indices-val :lambda-list '(m))
(cl:defmethod indices-val ((m <Indices>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:indices-val is deprecated.  Use perception_ros_msg-msg:indices instead.")
  (indices m))
