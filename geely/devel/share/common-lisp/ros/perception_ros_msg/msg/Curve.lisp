...
(cl:defmethod cl:initialize-instance :after ((m <Curve>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Curve)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name perception_ros_msg-msg:<Curve> is deprecated: use perception_ros_msg-msg:Curve instead.")))

(cl:ensure-generic-function 'x_start-val :lambda-list '(m))
(cl:defmethod x_start-val ((m <Curve>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:x_start-val is deprecated.  Use perception_ros_msg-msg:x_start instead.")
  (x_start m))

(cl:ensure-generic-function 'x_end-val :lambda-list '(m))
(cl:defmethod x_end-val ((m <Curve>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:x_end-val is deprecated.  Use perception_ros_msg-msg:x_end instead.")
  (x_end m))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <Curve>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:a-val is deprecated.  Use perception_ros_msg-msg:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <Curve>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:b-val is deprecated.  Use perception_ros_msg-msg:b instead.")
  (b m))

(cl:ensure-generic-function 'c-val :lambda-list '(m))
(cl:defmethod c-val ((m <Curve>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:c-val is deprecated.  Use perception_ros_msg-msg:c instead.")
  (c m))

(cl:ensure-generic-function 'd-val :lambda-list '(m))
(cl:defmethod d-val ((m <Curve>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:d-val is deprecated.  Use perception_ros_msg-msg:d instead.")
  (d m))
