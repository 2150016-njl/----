...
(cl:defclass <RoadEdges> (roslisp-msg-protocol:ros-message)
  ((curbs
    :reader curbs
    :initarg :curbs
    :type (cl:vector perception_ros_msg-msg:RoadEdge)
   :initform (cl:make-array 0 :element-type 'perception_ros_msg-msg:RoadEdge :initial-element (cl:make-instance 'perception_ros_msg-msg:RoadEdge))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <RoadEdges>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RoadEdges)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name perception_ros_msg-msg:<RoadEdges> is deprecated: use perception_ros_msg-msg:RoadEdges instead.")))

(cl:ensure-generic-function 'curbs-val :lambda-list '(m))
(cl:defmethod curbs-val ((m <RoadEdges>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:curbs-val is deprecated.  Use perception_ros_msg-msg:curbs instead.")
  (curbs m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RoadEdges>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'curbs)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'perception_ros_msg-msg:RoadEdge))
