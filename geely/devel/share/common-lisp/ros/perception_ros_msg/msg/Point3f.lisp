...
(cl:defmethod cl:initialize-instance :after ((m <Point3f>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point3f)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name perception_ros_msg-msg:<Point3f> is deprecated: use perception_ros_msg-msg:Point3f instead.")))
