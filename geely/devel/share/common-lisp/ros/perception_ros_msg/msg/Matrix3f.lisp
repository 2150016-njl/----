...
(cl:defmethod cl:initialize-instance :after ((m <Matrix3f>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Matrix3f)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name perception_ros_msg-msg:<Matrix3f> is deprecated: use perception_ros_msg-msg:Matrix3f instead.")))

(cl:ensure-generic-function 'matrix3x3-val :lambda-list '(m))
(cl:defmethod matrix3x3-val ((m <Matrix3f>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:matrix3x3-val is deprecated.  Use perception_ros_msg-msg:matrix3x3 instead.")
  (matrix3x3 m))
