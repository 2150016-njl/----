...
(cl:defmethod cl:initialize-instance :after ((m <Point2f>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point2f)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name perception_ros_msg-msg:<Point2f> is deprecated: use perception_ros_msg-msg:Point2f instead.")))
