...
(cl:defmethod cl:initialize-instance :after ((m <Point4f>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point4f)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name perception_ros_msg-msg:<Point4f> is deprecated: use perception_ros_msg-msg:Point4f instead.")))
...
(cl:defmethod i-val ((m <Point4f>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:i-val is deprecated.  Use perception_ros_msg-msg:i instead.")
  (i m))
