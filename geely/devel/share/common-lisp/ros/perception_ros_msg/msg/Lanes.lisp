...
(cl:defclass <Lanes> (roslisp-msg-protocol:ros-message)
  ((lanes
    :reader lanes
    :initarg :lanes
    :type (cl:vector perception_ros_msg-msg:Lane)
   :initform (cl:make-array 0 :element-type 'perception_ros_msg-msg:Lane :initial-element (cl:make-instance 'perception_ros_msg-msg:Lane))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Lanes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Lanes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name perception_ros_msg-msg:<Lanes> is deprecated: use perception_ros_msg-msg:Lanes instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Lanes>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'lanes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'perception_ros_msg-msg:Lane))
