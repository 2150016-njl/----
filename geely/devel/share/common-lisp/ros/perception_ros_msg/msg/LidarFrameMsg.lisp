...
(cl:defclass <LidarFrameMsg> (roslisp-msg-protocol:ros-message)
  ((frame_id
   ...
   (global_pose
    :reader global_pose
    :initarg :global_pose
    :type perception_ros_msg-msg:Pose
    :initform (cl:make-instance 'perception_ros_msg-msg:Pose))
   (gps_origin
    :reader gps_origin
    :initarg :gps_origin
    :type perception_ros_msg-msg:Point3d
    :initform (cl:make-instance 'perception_ros_msg-msg:Point3d))
   (status_pose_map
    :reader status_pose_map
    :initarg :status_pose_map
    :type perception_ros_msg-msg:PoseMap
    :initform (cl:make-instance 'perception_ros_msg-msg:PoseMap))
   (status
    :reader status
    :initarg :status
   ...
   (valid_indices
    ...
    :type perception_ros_msg-msg:Indices
    :initform (cl:make-instance 'perception_ros_msg-msg:Indices))
   (objects
    :reader objects
    :initarg :objects
    :type perception_ros_msg-msg:Objects
    :initform (cl:make-instance 'perception_ros_msg-msg:Objects))
   (has_pointcloud
   ...
   (scan_pointcloud
    ...
    :type (cl:vector perception_ros_msg-msg:Point4f)
   :initform (cl:make-array 0 :element-type 'perception_ros_msg-msg:Point4f :initial-element (cl:make-instance 'perception_ros_msg-msg:Point4f)))
   ...
   (freespace_infos
    ...
    :type perception_ros_msg-msg:FreeSpaceInfos
    :initform (cl:make-instance 'perception_ros_msg-msg:FreeSpaceInfos))
   (has_lanes
    :reader has_lanes
    :initarg :has_lanes
    :type std_msgs-msg:Bool
   ...
   (lanes
    :reader lanes
    :initarg :lanes
    :type perception_ros_msg-msg:Lanes
    :initform (cl:make-instance 'perception_ros_msg-msg:Lanes))
   (has_roadedges
   ...
   (roadedges
    :reader roadedges
    :initarg :roadedges
    :type perception_ros_msg-msg:RoadEdges
    :initform (cl:make-instance 'perception_ros_msg-msg:RoadEdges))
...
(cl:defmethod cl:initialize-instance :after ((m <LidarFrameMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LidarFrameMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name perception_ros_msg-msg:<LidarFrameMsg> is deprecated: use perception_ros_msg-msg:LidarFrameMsg instead.")))

(cl:ensure-generic-function 'frame_id-val :lambda-list '(m))
(cl:defmethod frame_id-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:frame_id-val is deprecated.  Use perception_ros_msg-msg:frame_id instead.")
  (frame_id m))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:timestamp-val is deprecated.  Use perception_ros_msg-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'global_pose-val :lambda-list '(m))
(cl:defmethod global_pose-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:global_pose-val is deprecated.  Use perception_ros_msg-msg:global_pose instead.")
  (global_pose m))

(cl:ensure-generic-function 'gps_origin-val :lambda-list '(m))
(cl:defmethod gps_origin-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:gps_origin-val is deprecated.  Use perception_ros_msg-msg:gps_origin instead.")
  (gps_origin m))

(cl:ensure-generic-function 'status_pose_map-val :lambda-list '(m))
(cl:defmethod status_pose_map-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:status_pose_map-val is deprecated.  Use perception_ros_msg-msg:status_pose_map instead.")
  (status_pose_map m))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:status-val is deprecated.  Use perception_ros_msg-msg:status instead.")
  (status m))

(cl:ensure-generic-function 'valid_indices-val :lambda-list '(m))
(cl:defmethod valid_indices-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:valid_indices-val is deprecated.  Use perception_ros_msg-msg:valid_indices instead.")
  (valid_indices m))

(cl:ensure-generic-function 'objects-val :lambda-list '(m))
(cl:defmethod objects-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:objects-val is deprecated.  Use perception_ros_msg-msg:objects instead.")
  (objects m))

(cl:ensure-generic-function 'has_pointcloud-val :lambda-list '(m))
(cl:defmethod has_pointcloud-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:has_pointcloud-val is deprecated.  Use perception_ros_msg-msg:has_pointcloud instead.")
  (has_pointcloud m))

(cl:ensure-generic-function 'scan_pointcloud-val :lambda-list '(m))
(cl:defmethod scan_pointcloud-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:scan_pointcloud-val is deprecated.  Use perception_ros_msg-msg:scan_pointcloud instead.")
  (scan_pointcloud m))

(cl:ensure-generic-function 'has_attention_objects-val :lambda-list '(m))
(cl:defmethod has_attention_objects-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:has_attention_objects-val is deprecated.  Use perception_ros_msg-msg:has_attention_objects instead.")
...
(cl:defmethod attention_objects-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:attention_objects-val is deprecated.  Use perception_ros_msg-msg:attention_objects instead.")
  (attention_objects m))

(cl:ensure-generic-function 'has_freespace-val :lambda-list '(m))
(cl:defmethod has_freespace-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:has_freespace-val is deprecated.  Use perception_ros_msg-msg:has_freespace instead.")
  (has_freespace m))

(cl:ensure-generic-function 'freespace_infos-val :lambda-list '(m))
(cl:defmethod freespace_infos-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:freespace_infos-val is deprecated.  Use perception_ros_msg-msg:freespace_infos instead.")
  (freespace_infos m))

(cl:ensure-generic-function 'has_lanes-val :lambda-list '(m))
(cl:defmethod has_lanes-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:has_lanes-val is deprecated.  Use perception_ros_msg-msg:has_lanes instead.")
  (has_lanes m))

(cl:ensure-generic-function 'lanes-val :lambda-list '(m))
(cl:defmethod lanes-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:lanes-val is deprecated.  Use perception_ros_msg-msg:lanes instead.")
  (lanes m))

(cl:ensure-generic-function 'has_roadedges-val :lambda-list '(m))
(cl:defmethod has_roadedges-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:has_roadedges-val is deprecated.  Use perception_ros_msg-msg:has_roadedges instead.")
  (has_roadedges m))

(cl:ensure-generic-function 'roadedges-val :lambda-list '(m))
(cl:defmethod roadedges-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:roadedges-val is deprecated.  Use perception_ros_msg-msg:roadedges instead.")
  (roadedges m))

(cl:ensure-generic-function 'has_sematice_indices-val :lambda-list '(m))
(cl:defmethod has_sematice_indices-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:has_sematice_indices-val is deprecated.  Use perception_ros_msg-msg:has_sematice_indices instead.")
...
(cl:defmethod non_ground_indices-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:non_ground_indices-val is deprecated.  Use perception_ros_msg-msg:non_ground_indices instead.")
...
(cl:defmethod ground_indices-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:ground_indices-val is deprecated.  Use perception_ros_msg-msg:ground_indices instead.")
  (ground_indices m))

(cl:ensure-generic-function 'background_indices-val :lambda-list '(m))
(cl:defmethod background_indices-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:background_indices-val is deprecated.  Use perception_ros_msg-msg:background_indices instead.")
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LidarFrameMsg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'scan_pointcloud)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'perception_ros_msg-msg:Point4f))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LidarFrameMsg>)))
  ...
  "perception_ros_msg/LidarFrameMsg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LidarFrameMsg)))
  "Returns string type for a message object of type 'LidarFrameMsg"
  "perception_ros_msg/LidarFrameMsg")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LidarFrameMsg>)))
  ...
  (cl:format cl:nil "~%~%std_msgs/String frame_id~%std_msgs/Float64 timestamp ~%Pose             global_pose ~%Point3d          gps_origin ~%PoseMap          status_pose_map ~%std_msgs/Int32   status ~%Indices          valid_indices ~%Objects          objects ~%~%std_msgs/Bool  has_pointcloud ~%Point4f[]      scan_pointcloud ~%~%std_msgs/Bool  has_attention_objects ~%Objects        attention_objects ~%~%std_msgs/Bool  has_freespace ~%FreeSpaceInfos freespace_infos ~%~%std_msgs/Bool   has_lanes ~%Lanes           lanes ~%~%std_msgs/Bool   has_roadedges ~%RoadEdges       roadedges ~%~%std_msgs/Bool   has_sematice_indices ~%Indices         non_ground_indices~%Indices         ground_indices ~%Indices         background_indices ~%~%================================================================================~%MSG: std_msgs/String~%string data~%~%================================================================================~%MSG: std_msgs/Float64~%float64 data~%================================================================================~%MSG: perception_ros_msg/Pose~%std_msgs/Float32 x ~%std_msgs/Float32 y ~%std_msgs/Float32 z ~%~%std_msgs/Float32 roll ~%std_msgs/Float32 pitch~%std_msgs/Float32 yaw~%~%std_msgs/Int32 status ~%~%================================================================================~%MSG: std_msgs/Float32~%float32 data~%================================================================================~%MSG: std_msgs/Int32~%int32 data~%================================================================================~%MSG: perception_ros_msg/Point3d~%std_msgs/Float64 x ~%std_msgs/Float64 y ~%std_msgs/Float64 z ~%~%================================================================================~%MSG: perception_ros_msg/PoseMap~%AxisStatusPose[] status_poses ~%~%================================================================================~%MSG: perception_ros_msg/AxisStatusPose~%std_msgs/Int32 status ~%Pose           pose ~%================================================================================~%MSG: perception_ros_msg/Indices~%std_msgs/Int32[]    indices~%================================================================================~%MSG: perception_ros_msg/Objects~%Object[]         objects~%================================================================================~%MSG: perception_ros_msg/Object~%CoreInfo coreinfo~%std_msgs/Bool  hassupplmentinfo ~%SupplementInfo supplementinfo ~%~%================================================================================~%MSG: perception_ros_msg/CoreInfo~%std_msgs/Float64 timestamp~%~%std_msgs/Int32 priority_id~%std_msgs/Float32 exist_confidence ~%Point3f          center ~%Point3f          center_cov ~%Point3f          size ~%Point3f          size_cov ~%Point3f          direction ~%Point3f          direction_cov         ~%std_msgs/Int32   type ~%std_msgs/Float32 type_confidence ~%std_msgs/Int32   attention_type ~%std_msgs/Int32   motion_state~%std_msgs/Int32   lane_pos~%std_msgs/Int32   trakcer_id ~%std_msgs/Float64 age ~%Point3f          velocity ~%Point3f          velocity_cov ~%Point3f          acceleration ~%Point3f          acceleration_cov ~%std_msgs/Float32 angle_velocity ~%std_msgs/Float32 angle_velocity_cov ~%std_msgs/Float32 angle_acceleration ~%std_msgs/Float32 angle_acceleration_cov  ~%Point3f          anchor ~%Point3f          nearest_point ~%~%~%================================================================================~%MSG: perception_ros_msg/Point3f~%std_msgs/Float32 x ~%std_msgs/Float32 y ~%std_msgs/Float32 z ~%================================================================================~%MSG: std_msgs/Bool~%bool data~%================================================================================~%MSG: perception_ros_msg/SupplementInfo~%std_msgs/UInt32     unique_id~%~%Point3f[]           polygon~%std_msgs/Int32      left_point_index ~%std_msgs/Int32      right_point_index ~%~%std_msgs/Int32[]    cloud_indices~%~%std_msgs/Float32[]  latent_types~%std_msgs/Int32      size_type ~%std_msgs/Int32      mode ~%std_msgs/Bool       in_roi ~%std_msgs/Int32      tracking_state~%Point3f             geo_center ~%Point3f             geo_size ~%~%~%~%Point3f[]           trajectory ~%Point3f[]           history_velocity~%std_msgs/Int32[]    history_type ~%std_msgs/Int32      gps_mode ~%Point3d             gps_info ~%~%================================================================================~%MSG: std_msgs/UInt32~%uint32 data~%================================================================================~%MSG: perception_ros_msg/Point4f~%std_msgs/Float32 x ~%std_msgs/Float32 y ~%std_msgs/Float32 z ~%std_msgs/Float32 i ~%~%================================================================================~%MSG: perception_ros_msg/FreeSpaceInfos~%Point3f[]        fs_pts~%std_msgs/Float32[] fs_confidence ~%~%================================================================================~%MSG: perception_ros_msg/Lanes~%Lane[] lanes~%================================================================================~%MSG: perception_ros_msg/Lane~%std_msgs/Int32   lane_id ~%Curve            curve ~%EndPoints        end_points ~%std_msgs/Int32   measure_status  ~%std_msgs/Float32 confidence ~%~%================================================================================~%MSG: perception_ros_msg/Curve~%std_msgs/Float32 x_start ~%std_msgs/Float32 x_end ~%std_msgs/Float32 a ~%std_msgs/Float32 b ~%std_msgs/Float32 c ~%std_msgs/Float32 d ~%================================================================================~%MSG: perception_ros_msg/EndPoints~%Point2f start ~%Point2f end ~%~%================================================================================~%MSG: perception_ros_msg/Point2f~%std_msgs/Float32 x ~%std_msgs/Float32 y ~%~%================================================================================~%MSG: perception_ros_msg/RoadEdges~%RoadEdge[] curbs~%~%================================================================================~%MSG: perception_ros_msg/RoadEdge~%std_msgs/Int32   roadedge_id  ~%Curve            curve ~%EndPoints        end_points ~%std_msgs/Int32   measure_status  ~%std_msgs/Float32 confidence ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LidarFrameMsg)))
  "Returns full string definition for message of type 'LidarFrameMsg"
  (cl:format cl:nil "~%~%std_msgs/String frame_id~%std_msgs/Float64 timestamp ~%Pose             global_pose ~%Point3d          gps_origin ~%PoseMap          status_pose_map ~%std_msgs/Int32   status ~%Indices          valid_indices ~%Objects          objects ~%~%std_msgs/Bool  has_pointcloud ~%Point4f[]      scan_pointcloud ~%~%std_msgs/Bool  has_attention_objects ~%Objects        attention_objects ~%~%std_msgs/Bool  has_freespace ~%FreeSpaceInfos freespace_infos ~%~%std_msgs/Bool   has_lanes ~%Lanes           lanes ~%~%std_msgs/Bool   has_roadedges ~%RoadEdges       roadedges ~%~%std_msgs/Bool   has_sematice_indices ~%Indices         non_ground_indices~%Indices         ground_indices ~%Indices         background_indices ~%~%================================================================================~%MSG: std_msgs/String~%string data~%~%================================================================================~%MSG: std_msgs/Float64~%float64 data~%================================================================================~%MSG: perception_ros_msg/Pose~%std_msgs/Float32 x ~%std_msgs/Float32 y ~%std_msgs/Float32 z ~%~%std_msgs/Float32 roll ~%std_msgs/Float32 pitch~%std_msgs/Float32 yaw~%~%std_msgs/Int32 status ~%~%================================================================================~%MSG: std_msgs/Float32~%float32 data~%================================================================================~%MSG: std_msgs/Int32~%int32 data~%================================================================================~%MSG: perception_ros_msg/Point3d~%std_msgs/Float64 x ~%std_msgs/Float64 y ~%std_msgs/Float64 z ~%~%================================================================================~%MSG: perception_ros_msg/PoseMap~%AxisStatusPose[] status_poses ~%~%================================================================================~%MSG: perception_ros_msg/AxisStatusPose~%std_msgs/Int32 status ~%Pose           pose ~%================================================================================~%MSG: perception_ros_msg/Indices~%std_msgs/Int32[]    indices~%================================================================================~%MSG: perception_ros_msg/Objects~%Object[]         objects~%================================================================================~%MSG: perception_ros_msg/Object~%CoreInfo coreinfo~%std_msgs/Bool  hassupplmentinfo ~%SupplementInfo supplementinfo ~%~%================================================================================~%MSG: perception_ros_msg/CoreInfo~%std_msgs/Float64 timestamp~%~%std_msgs/Int32 priority_id~%std_msgs/Float32 exist_confidence ~%Point3f          center ~%Point3f          center_cov ~%Point3f          size ~%Point3f          size_cov ~%Point3f          direction ~%Point3f          direction_cov         ~%std_msgs/Int32   type ~%std_msgs/Float32 type_confidence ~%std_msgs/Int32   attention_type ~%std_msgs/Int32   motion_state~%std_msgs/Int32   lane_pos~%std_msgs/Int32   trakcer_id ~%std_msgs/Float64 age ~%Point3f          velocity ~%Point3f          velocity_cov ~%Point3f          acceleration ~%Point3f          acceleration_cov ~%std_msgs/Float32 angle_velocity ~%std_msgs/Float32 angle_velocity_cov ~%std_msgs/Float32 angle_acceleration ~%std_msgs/Float32 angle_acceleration_cov  ~%Point3f          anchor ~%Point3f          nearest_point ~%~%~%================================================================================~%MSG: perception_ros_msg/Point3f~%std_msgs/Float32 x ~%std_msgs/Float32 y ~%std_msgs/Float32 z ~%================================================================================~%MSG: std_msgs/Bool~%bool data~%================================================================================~%MSG: perception_ros_msg/SupplementInfo~%std_msgs/UInt32     unique_id~%~%Point3f[]           polygon~%std_msgs/Int32      left_point_index ~%std_msgs/Int32      right_point_index ~%~%std_msgs/Int32[]    cloud_indices~%~%std_msgs/Float32[]  latent_types~%std_msgs/Int32      size_type ~%std_msgs/Int32      mode ~%std_msgs/Bool       in_roi ~%std_msgs/Int32      tracking_state~%Point3f             geo_center ~%Point3f             geo_size ~%~%~%~%Point3f[]           trajectory ~%Point3f[]           history_velocity~%std_msgs/Int32[]    history_type ~%std_msgs/Int32      gps_mode ~%Point3d             gps_info ~%~%================================================================================~%MSG: std_msgs/UInt32~%uint32 data~%================================================================================~%MSG: perception_ros_msg/Point4f~%std_msgs/Float32 x ~%std_msgs/Float32 y ~%std_msgs/Float32 z ~%std_msgs/Float32 i ~%~%================================================================================~%MSG: perception_ros_msg/FreeSpaceInfos~%Point3f[]        fs_pts~%std_msgs/Float32[] fs_confidence ~%~%================================================================================~%MSG: perception_ros_msg/Lanes~%Lane[] lanes~%================================================================================~%MSG: perception_ros_msg/Lane~%std_msgs/Int32   lane_id ~%Curve            curve ~%EndPoints        end_points ~%std_msgs/Int32   measure_status  ~%std_msgs/Float32 confidence ~%~%================================================================================~%MSG: perception_ros_msg/Curve~%std_msgs/Float32 x_start ~%std_msgs/Float32 x_end ~%std_msgs/Float32 a ~%std_msgs/Float32 b ~%std_msgs/Float32 c ~%std_msgs/Float32 d ~%================================================================================~%MSG: perception_ros_msg/EndPoints~%Point2f start ~%Point2f end ~%~%================================================================================~%MSG: perception_ros_msg/Point2f~%std_msgs/Float32 x ~%std_msgs/Float32 y ~%~%================================================================================~%MSG: perception_ros_msg/RoadEdges~%RoadEdge[] curbs~%~%================================================================================~%MSG: perception_ros_msg/RoadEdge~%std_msgs/Int32   roadedge_id  ~%Curve            curve ~%EndPoints        end_points ~%std_msgs/Int32   measure_status  ~%std_msgs/Float32 confidence ~%~%~%"))
