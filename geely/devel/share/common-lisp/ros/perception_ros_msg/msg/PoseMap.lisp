...
(cl:defclass <PoseMap> (roslisp-msg-protocol:ros-message)
  ((status_poses
    ...
    :type (cl:vector perception_ros_msg-msg:AxisStatusPose)
   :initform (cl:make-array 0 :element-type 'perception_ros_msg-msg:AxisStatusPose :initial-element (cl:make-instance 'perception_ros_msg-msg:AxisStatusPose))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PoseMap>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PoseMap)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name perception_ros_msg-msg:<PoseMap> is deprecated: use perception_ros_msg-msg:PoseMap instead.")))

(cl:ensure-generic-function 'status_poses-val :lambda-list '(m))
(cl:defmethod status_poses-val ((m <PoseMap>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_ros_msg-msg:status_poses-val is deprecated.  Use perception_ros_msg-msg:status_poses instead.")
  (status_poses m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PoseMap>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'status_poses)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'perception_ros_msg-msg:AxisStatusPose))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PoseMap>)))
  ...
  (cl:format cl:nil "AxisStatusPose[] status_poses ~%~%================================================================================~%MSG: perception_ros_msg/AxisStatusPose~%std_msgs/Int32 status ~%Pose           pose ~%================================================================================~%MSG: std_msgs/Int32~%int32 data~%================================================================================~%MSG: perception_ros_msg/Pose~%std_msgs/Float32 x ~%std_msgs/Float32 y ~%std_msgs/Float32 z ~%~%std_msgs/Float32 roll ~%std_msgs/Float32 pitch~%std_msgs/Float32 yaw~%~%std_msgs/Int32 status ~%~%================================================================================~%MSG: std_msgs/Float32~%float32 data~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PoseMap)))
  "Returns full string definition for message of type 'PoseMap"
  (cl:format cl:nil "AxisStatusPose[] status_poses ~%~%================================================================================~%MSG: perception_ros_msg/AxisStatusPose~%std_msgs/Int32 status ~%Pose           pose ~%================================================================================~%MSG: std_msgs/Int32~%int32 data~%================================================================================~%MSG: perception_ros_msg/Pose~%std_msgs/Float32 x ~%std_msgs/Float32 y ~%std_msgs/Float32 z ~%~%std_msgs/Float32 roll ~%std_msgs/Float32 pitch~%std_msgs/Float32 yaw~%~%std_msgs/Int32 status ~%~%================================================================================~%MSG: std_msgs/Float32~%float32 data~%~%"))
