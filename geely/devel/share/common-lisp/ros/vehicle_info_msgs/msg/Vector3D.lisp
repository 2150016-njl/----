...
(cl:defmethod cl:initialize-instance :after ((m <Vector3D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vector3D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vehicle_info_msgs-msg:<Vector3D> is deprecated: use vehicle_info_msgs-msg:Vector3D instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Vector3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vehicle_info_msgs-msg:x-val is deprecated.  Use vehicle_info_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Vector3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vehicle_info_msgs-msg:y-val is deprecated.  Use vehicle_info_msgs-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Vector3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vehicle_info_msgs-msg:z-val is deprecated.  Use vehicle_info_msgs-msg:z instead.")
  (z m))
