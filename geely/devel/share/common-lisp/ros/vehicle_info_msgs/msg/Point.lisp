...
(cl:defmethod cl:initialize-instance :after ((m <Point>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vehicle_info_msgs-msg:<Point> is deprecated: use vehicle_info_msgs-msg:Point instead.")))
